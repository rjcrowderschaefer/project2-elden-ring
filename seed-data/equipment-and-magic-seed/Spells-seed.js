        ...
        sorceries: [
            {
                ...
                officalKobyRating: 'B tier, annoying in PVP and Gideon uses it. But it does lots of poise damage',
                type: 'Sorcery',
            ...
            },
            {
                ...
                officalKobyRating: 'A tier, looks cool and does a lot of damage, but easy to dodge',
                type: 'Sorcery',
            ...
            },
            {
                ...
                officalKobyRating: 'B tier, it absolutely slaps in PVE because of the damage it does but its pretty booty in PVP because it renders you unable to move, it is super slow and it is super easy to dodge',
                type: 'Sorcery',
            ...
            },
            {
                ...
                officalKobyRating: 'F tier, if you use this in PVP, you are scum of the earth',
                type: 'Sorcery',
                class: 'Primeval Sorcery',
                damageType: 'Magic',
                requiredMemory: '1',
            ...
            },
            {
                ...
                officalKobyRating: 'D tier, probably one of the coolest spells in the game but the risk of the slow casting time and the reward of mediocre damage makes this spell not very good',
                type: 'Sorcery',
            ...
            },
            {
                ...
                officalKobyRating: 'B tier, ive actually never used this spell but it has blood loss buildup so thats cool.',
                type: 'Sorcery',
            ...
            },
            {
                ...
                officalKobyRating: 'B tier, very good in PVE with high damage but like comet azure, slow and easy to dodge in PVP',
                type: 'Sorcery',
            ...
            },
            {
                ...
                officalKobyRating: 'A tier, extremely easy to buff damage to maximize damage and low fp cost. Like most sorceries, it is annoying in PVP',
                type: 'Sorcery',
            ...
            },
            {
                ...
                officalKobyRating: 'F tier, this spell is literally exactly like a lantern but it costs fp to use and goes out after awhile. dont waste a memory slot or fp and just buy yourself a lantern',
                type: 'Sorcery',
                class: 'Glintstone Sorcery',
                damageType: 'none',
                requiredMemory: '1',
            ...
            },
            {
                ...
                officalKobyRating: 'S tier, probably one of the best PVE spells in the game. Very buffable, super fast and chain castable for loads of damage. In PVP, however, if you use this, i know you think youre cool for using a magic sword from your staff. youre annoying. Be a man and use a real sword',
                type: 'Sorcery',
                class: 'Carian Sorcery',
                damageType: 'Magic',
                requiredMemory: '1',
        ...
        incantations: [
            {
                ...
                officalKobyRating: 'S tier, This is my favourite incantation for PVE. its fast, chargable, and does fire damage which makes this spell extremely buffable along with fire damage being one of the most common weaknesses. Also string in PVP but the casting time is too slow for how much range it has',
                type: 'Incantation',
            ...
            },
            {
                ...
                officalKobyRating: 'S tier, its basically a mini nuke. Need i say more?',
                type: 'Incantation',
            ...
            },
            {
                ...
                officalKobyRating: 'B tier, mmmm rock, yes. i throw rock. Big stone',
                type: 'Incantation',
            ...
            },
            {
                ...
                officalKobyRating: 'B tier, very good spell that is chargable and does fire damage with a drawback of the madness buildup when used. If a schizophrenic could cast a spell, this is what it would look like.',
                type: 'Incantation',
            ...
            },
            {
                ...
                officalKobyRating: 'A tier, longest ranged spell in the game and is super buffable. Good Luck Hitting someone with this in PVP, it is quite slow and easy to dodge',
                type: 'Incantation',
                class: 'Frenzied Flame Incantation',
                damageType: 'Fire (with madness buildup)',
                requiredMemory: '1',
            ...
            },
            {
                ...
                officalKobyRating: 'D tier, its not F tier because grab attacks are funny in PVP but it is ranked so low because it only works on human enemies which are probably one of the the least abundant enemies in the game so its usage is very very limited',
                type: 'Incantation',
                class: 'Frenzied Flame Incantation',
                damageType: 'Fire (with madness buildup)',
                requiredMemory: '1',
            ...
            },
            {
                ...
                officalKobyRating: 'S tier, buffs physical and fire damage by 20%. Very very strong in all scenarios',
                type: 'Incantation',
                class: 'Fire Monk Incantation',
                damageType: 'none',
                requiredMemory: '1',
            ...
            },
            {
                ...
                officalKobyRating: 'S tier, the ultimate counter to magic users in PVP. Reduces magic damage taken by 60%',
                type: 'Incantation',
            ...
            },
            {
                ...
                officalKobyRating: 'B tier, it does a lot of holy damage and casts very quick aith a large AOE. However, it suffers from a massive fp cost. it is funny to use in PVP because it does a lot of damage and launches them away from you',
                type: 'Incantation',
                class: 'Erdtree Incantation',
                damageType: 'Holy',
                requiredMemory: '1',
